        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            <Text style={styles.body}>
              Ticku is an open source coffee brewing timer and recipe manager.
              No accounts, no cloud — your data lives on your device.
            </Text>
          </View>
          <View style={styles.section}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.body}>
              Ticku is open source. Contributions, bug reports, and feature
              requests are welcome on GitHub.
            </Text>
            <TouchableOpacity
              style={styles.githubBtn}
              onPress={() =>
                Linking.openURL("https://github.com/AbbeyIT/Ticku")
              }
            >
